...
class SlackNotificationChannel(
    ...
    private fun createSlackFields(notification: NotificationTask): List<SlackField> {
        ...
        fields.add(
            SlackField(
                "Triggered At",
                alert.triggeredAt.atZone(java.time.ZoneId.systemDefault()).format(timeFormatter),
                true,
            ),
        )
        ...
        if (alert.resolvedAt != null) {
            fields.add(
                SlackField(
                    "Resolved At",
                    alert.resolvedAt!!.atZone(java.time.ZoneId.systemDefault()).format(timeFormatter),
                    true,
                ),
            )
        }
