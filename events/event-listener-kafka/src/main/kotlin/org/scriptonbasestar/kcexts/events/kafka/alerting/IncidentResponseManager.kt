...
class IncidentResponseManager(
     ...
     */
    private fun executeRemediationStep(
        incident: Incident,
        ...
        while (attempts <= step.retryCount && !success) {
            ...
            try {
                logger.info(
                    "Executing remediation step: ${step.description} (attempt $attempts/${step.retryCount + 1})",
                )
