...
class ConnectionPoolManager(
    ...
    private val maintenanceExecutor = Executors.newSingleThreadScheduledExecutor { r ->
    ...
    private fun logPoolStatistics() {
        ...
        logger.debug("Pool stats - Total: ${stats.totalConnections}, " +
    ...
    fun healthCheck(): PoolHealthStatus {
        ...
        val threadUtilization = if (config.maxThreads > 0) {
