...
class KafkaEventMetrics : MeterBinder {
    ...
    fun recordEventSent(
        ...
        val counter =
            eventCounters.computeIfAbsent("$eventType:$realm:$topic") {
    ...
    fun recordEventFailed(
        ...
        val counter =
            errorCounters.computeIfAbsent("$eventType:$realm:$topic:$errorType") {
     ...
     */
    fun recordEventProcessingTime(
        eventType: String,
        duration: Duration,
    ): Timer.Sample {
        val timer =
            timers.computeIfAbsent(eventType) {
