...
class KafkaSecurityConfig {
     ...
     */
    private fun configureAdditionalSecurity(
        config: Properties,
        securityConfig: SecurityConfiguration,
    ) {
     ...
     */
    private fun buildPlainJaasConfig(
        username: String?,
        password: String?,
    ): String {
     ...
     */
    private fun buildScramJaasConfig(
        username: String?,
        password: String?,
    ): String {
        if (username.isNullOrEmpty() || password.isNullOrEmpty()) {
     ...
     */
    private fun validateKeystoreFile(
        filePath: String,
        type: String,
    ) {
